...
<meta http-equiv="refresh" content="8;url=<?php echo Config::$application_domain ?>/home.php" /> 
  ...
  <table width="1000" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td colspan="2" rowspan="3" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
        <tr>
          <td width="958" height="70" valign="top" bgcolor="#FFFFFF" ><p align="justify" class="StyleMssg">If you have any questions or need further information about our services, please feel free to contact us; if this is a matter related to technical support, don't hesitate to do so as well, it&rsquo;s free of charge. <br />
            <br />
            </p></td>
          </tr>
        <tr>
          <td height="395" valign="top" ><div align="center">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
              <!--DWLayoutTable-->
              <tr>
                <td width="207" height="395">&nbsp;</td>
                    <td width="468" valign="top"><div align="center">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                          
                            <!--DWLayoutTable-->
                            <tr>
                              <td width="468" height="90">&nbsp;</td>
                            </tr>
                            <tr>
                              <td height="179" align="right" valign="top"><p align="center" class="style5">Your message has been sent.<br />
        ...
        <tr>
          <td height="65" valign="top" bgcolor="#FFFFFF" ><p align="justify" class="StyleMssg"><a href="signUp.php" target="_top">Sign up</a> with Green Apple Mail today and start validating your lists of email addresses! <a href="signUp.php" target="_top">Signing-up</a> takes less than 30 seconds. </p></td>
          </tr>
        <tr>
