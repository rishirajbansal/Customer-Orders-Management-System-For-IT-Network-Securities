...
<style type="text/css">
<!--
.style107 {font-size: 18px; color: #333333;}
-->
</style>
</head>
  ...
  <table width="1000" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td colspan="2" rowspan="3" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
        <tr>
          <td width="958" height="50" valign="top" bgcolor="#FFFFFF" ><h1 align="justify" class="style1 style108  style107">Just pay for the records you need to validate! <br />
