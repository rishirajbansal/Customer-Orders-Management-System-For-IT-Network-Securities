...
<meta name="description" content="This document contains the terms and conditions that govern your use of the SERVICE and imposes material limitations to your rights. Please read this document carefully and treat it as valuable property.">
...
<title>Green Apple Mail  &copy; 2012 - Terms of Service</title>
...
.style6 {color: #92B5DF; font-weight: bold; font-size: 16px; }
-->
</style></head>
  ...
  <table width="1000" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="60" colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
        <tr>
          <td width="385" height="60" valign="top"><img src="Images/GAMPageTerms.jpg" width="385" height="60" /></td>
          </tr>
      </table></td>
    ...
    <tr>
      ...
      <td colspan="2" rowspan="3" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
              <td width="958" height="510" align="center" valign="middle" bgcolor="#FFFFFF" ><iframe src="termsandcond.html" width="900" height="440" frameborder="1" style="border-color:#000033" scrolling="yes" ></iframe></td>
          </tr>
