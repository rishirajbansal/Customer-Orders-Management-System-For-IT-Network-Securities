...
if (!empty($_SESSION['loggedIn']) && ($_SESSION['loggedIn'] == 1) && !empty($_SESSION['email']) && !empty($_SESSION['isAdmin']) && ($_SESSION['isAdmin'] == 1)) {
    ...
    if (isset($_POST['COCASEPromoBsubmit_x']) && isset($_POST['COCASEPromoBsubmit_y'])){
        $orderObj = new Order();
        setPOSTData($orderObj);
        
        $customerOrders = new CustomersOrders();
        $customerOrders->setOrder($orderObj);
        $result = $customerOrders->updatePromotionB_Order();
        
        $orders = $_SESSION['$adminCustomerPromotionBOrders'];
        $order = $orders[$_POST['counter']];
        $order['comments'] = $orderObj->getComments();
        $order['timer'] = $orderObj->getTimer();
        ...
        $statusArray = array(
                            ...
                            'status4A_delete'    =>  $orderObj->getStatus4A_delete(),
                            'status4A_apple'     =>  $orderObj->getStatus4A_apple(),
                            'status4A_demo'      =>  $orderObj->getStatus4A_demo(),
                            'status4B_delete'    =>  $orderObj->getStatus4B_delete(),
                            'status4B_apple'     =>  $orderObj->getStatus4B_apple(),
                            'status4B_demo'      =>  $orderObj->getStatus4B_demo(),
        ...
        $_SESSION['$adminCustomerPromotionBOrders'] = $orders;
        ...
        $orders = $_SESSION['$adminCustomerPromotionBOrders'];
        $order = $orders[$_SESSION['$adminCustomerPromotionBOrdersCtr']];
...
<meta name="ROBOTS" content="NOINDEX,NOFOLLOW">
<title>Order PROMO TYPE B</title>
...
<div align="center">
    <form id="COCASEPROMOBform" name="COCASEPROMOBform" method="post" action="">
      ...
      <td width="1004" height="70" valign="top"><table width="1000" height="60" border="1px" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border:solid 1px;">
        ...
        <tr>
          <td width="75" height="24" align="center" valign="middle" bgcolor="#F0F0FF" class="style12"><strong>ORDER</strong></td>
            <td width="117" align="center" valign="middle" bgcolor="#F0F0FF" class="style12"><strong>DATE OF CREATI ON </strong></td>
        ...
        <tr>
            ...
            <?php 
                if ($order['status'] == '1' || $order['status'] == '2' || $order['status'] == '3'){ ?>
                    <td align="center" valign="middle"><a onclick="return popupnow2('../securezone/CreditWarningMessage.php?amount=<?php echo $order['amount']; ?>&orderid=<?php echo $order['orderid']; ?>&counter=<?php echo $order['ctr']; ?>&clientid=<?php echo $order['clientid']; ?>&from=COCasePromoB')"><img src="../Images/DeleteRound.png" width="22" height="22" border="0" /></a></td>
                <?php  }
                else{ ?>
                    <td align="center" valign="middle"><a onclick="return popupnow2('../securezone/WarningMessage.php?orderid=<?php echo $order['orderid']; ?>&counter=<?php echo $order['ctr']; ?>&clientid=<?php echo $order['clientid']; ?>&from=COCasePromoB')"><img src="../Images/DeleteRound.png" width="22" height="22" border="0" /></a></td>
                <?php  }
            ?>      
          ...
          <td width="100" height="260" valign="top"><table style="border-left: solid 1px; border-right:solid 1px;" bordercolor="#999999" width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="42" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                <!--DWLayoutTable-->
                <tr>
                  <td width="91" height="42" align="center" valign="middle" bgcolor="#99FF99" class="style12"><img src="../Images/DeleteRound.png" width="22" height="22" /></td>
                      </tr>
            ...
            <td width="100" valign="top"><table style="border-left: solid 1px; border-right:solid 1px;" bordercolor="#999999" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td height="90" align="center" valign="middle" class="style12">ORDER WITH<br />
                    PROMO TYPE B
                    <br />
                    <br />
                    MESSAGE 1<br />
                ...
                <tr>
                  <td height="42" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <!--DWLayoutTable-->
                    <tr>
                      <td width="48" height="19" align="center" valign="middle" bgcolor="#99FF99" class="style12">ON</td>
                        <td width="43" align="center" valign="middle" bgcolor="#99FF99" class="style12">OFF</td>
                      </tr>
                    <tr>
                      <td height="23" align="center" valign="middle" bgcolor="#99FF99">
                ...
                <tr>
                  <td height="21" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td width="91" height="21" align="center" valign="middle" bgcolor="#FF3300">
                        <label>
                          <input name="Status" type="radio" value="1B" <?php if ($order['status'] == '1B'){ ?> checked="checked" <?php } ?> />
                        </label>               </td>
                      </tr>
                  </table></td>
                </tr>
            ...
            <td width="100" valign="top"><table style="border-left: solid 1px; border-right:solid 1px;" bordercolor="#999999" width="100%" cellpadding="0" cellspacing="0">
                <!--DWLayoutTable-->
                <tr>
                  <td width="91" height="21" align="center" valign="middle" bgcolor="#F0F0FF" class="style12">STATUS 4A </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td height="42" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="23" align="center" valign="middle" bgcolor="#99FF99">
                        <input name="status4A_delete_button" type="radio" value="1" <?php if ($statusArray['status4A_delete'] == 1){ ?> checked="checked" <?php } ?> />                </td>
                          <td align="center" valign="middle" bgcolor="#99FF99">
                          <input name="status4A_delete_button" type="radio" value="0" <?php if ($statusArray['status4A_delete'] == 0){ ?> checked="checked" <?php } ?> />                </td> 
                      </tr>
                  </table></td>
                </tr>
                <tr>
                  <td height="42" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="23" align="center" valign="middle" bgcolor="#FFFFFF">
                        <input name="status4A_apple_button" type="radio" value="1" <?php if ($statusArray['status4A_apple'] == 1){ ?> checked="checked" <?php } ?> />                </td>
                          <td align="center" valign="middle" bgcolor="#FFFFFF">
                          <input name="status4A_apple_button" type="radio" value="0" <?php if ($statusArray['status4A_apple'] == 0){ ?> checked="checked" <?php } ?> />                </td> 
                      </tr>
                  </table></td>
                </tr>
                <tr>
                  <td height="42" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="23" align="center" valign="middle" bgcolor="#CCD5FF">
                        <input name="status4A_demo_button" type="radio" value="1" <?php if ($statusArray['status4A_demo'] == 1){ ?> checked="checked" <?php } ?> />                </td>
                          <td align="center" valign="middle" bgcolor="#CCD5FF">
                          <input name="status4A_demo_button" type="radio" value="0" <?php if ($statusArray['status4A_demo'] == 0){ ?> checked="checked" <?php } ?> />                    </td> 
                      </tr>
                  </table></td>
                </tr>
                <tr>
                  <td height="21" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td width="91" height="21" align="center" valign="middle" bgcolor="#FF3300">
                        <label>
                          <input name="Status" type="radio" value="4A" <?php if ($order['status'] == '4A'){ ?> checked="checked" <?php } ?> />
                        </label>               </td>
                      </tr>
                  </table></td>
                </tr>
            ...
            <td width="100" valign="top"><table style="border-left: solid 1px; border-right:solid 1px;" bordercolor="#999999" width="100%" cellpadding="0" cellspacing="0">
                <!--DWLayoutTable-->
                <tr>
                  <td width="91" height="21" align="center" valign="middle" bgcolor="#F0F0FF" class="style12">STATUS 4B </td>
                </tr>
                <tr>
                  <td height="90" align="center" valign="middle" class="style12">PAID OK <br />
                    <br />
                    RECEIPT PDF <br />
                    MESSAGE 4B <br />
                    IMAGE 4<br />
                ...
                <tr>
                  <td height="42" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="23" align="center" valign="middle" bgcolor="#99FF99">
                        <input name="status4B_delete_button" type="radio" value="1" <?php if ($statusArray['status4B_delete'] == 1){ ?> checked="checked" <?php } ?> />                </td>
                          <td align="center" valign="middle" bgcolor="#99FF99">
                          <input name="status4B_delete_button" type="radio" value="0" <?php if ($statusArray['status4A_delete'] == 0){ ?> checked="checked" <?php } ?> />                </td> 
                      </tr>
                  </table></td>
                </tr>
                <tr>
                  <td height="42" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="23" align="center" valign="middle" bgcolor="#FFFFFF">
                        <input name="status4B_apple_button" type="radio" value="1" <?php if ($statusArray['status4B_apple'] == 1){ ?> checked="checked" <?php } ?> />                </td>
                          <td align="center" valign="middle" bgcolor="#FFFFFF">
                          <input name="status4B_apple_button" type="radio" value="0" <?php if ($statusArray['status4B_apple'] == 0){ ?> checked="checked" <?php } ?> />                </td> 
                      </tr>
                  </table></td>
                </tr>
                <tr>
                  <td height="42" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="23" align="center" valign="middle" bgcolor="#CCD5FF">
                        <input name="status4B_demo_button" type="radio" value="1" <?php if ($statusArray['status4B_demo'] == 1){ ?> checked="checked" <?php } ?> />                </td>
                          <td align="center" valign="middle" bgcolor="#CCD5FF">
                          <input name="status4B_demo_button" type="radio" value="0" <?php if ($statusArray['status4B_demo'] == 0){ ?> checked="checked" <?php } ?> />                    </td> 
                      </tr>
                  </table></td>
                </tr>
                <tr>
                  <td height="21" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td width="91" height="21" align="center" valign="middle" bgcolor="#FF3300">
                        <label>
                          <input name="Status" type="radio" value="4B" <?php if ($order['status'] == '4B'){ ?> checked="checked" <?php } ?> />
                        </label>               </td>
                      </tr>
                  </table></td>
                </tr>
            ...
            <td width="100" valign="top"><table style="border-left: solid 1px; border-right:solid 1px;" bordercolor="#999999" width="100%" cellpadding="0" cellspacing="0">
                <!--DWLayoutTable-->
                <tr>
                  <td width="91" height="21" align="center" valign="middle" bgcolor="#F0F0FF" class="style12">STATUS 5B</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td height="21" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td width="91" height="21" align="center" valign="middle" bgcolor="#FF3300">
                        <label>
                          <input name="Status" type="radio" value="5B" <?php if ($order['status'] == '5B'){ ?> checked="checked" <?php } ?> />
                        </label>               </td>
                      </tr>
                  </table></td>
                </tr>
            ...
            <td width="100" valign="top"><table style="border-left: solid 1px; border-right:solid 1px;" bordercolor="#999999" width="100%" cellpadding="0" cellspacing="0">
                <!--DWLayoutTable-->
                <tr>
                  <td width="91" height="21" align="center" valign="middle" bgcolor="#F0F0FF" class="style12">STATUS 6B</td>
                </tr>
                <tr>
                  <td height="90" align="center" valign="middle" class="style12">ALL DATA WILL <br />
                    BE DELETED <br />
                ...
                <tr>
                  <td height="21" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td width="91" height="21" align="center" valign="middle" bgcolor="#FF3300">
                        <label>
                          <input name="Status" type="radio" value="6B" <?php if ($order['status'] == '6B'){ ?> checked="checked" <?php } ?> />
                        </label>               </td>
                      </tr>
                  </table></td>
                </tr>
            ...
            <td width="100" valign="top"><table style="border-left: solid 1px; border-right:solid 1px;" bordercolor="#999999" width="100%" cellpadding="0" cellspacing="0">
                <!--DWLayoutTable-->
                <tr>
                  <td width="91" height="21" align="center" valign="middle" bgcolor="#F0F0FF" class="style12">STATUS 7B </td>
                </tr>
                <tr>
                  <td height="90" align="center" valign="middle" class="style12">ALL DATA WILL <br />
                    BE DELETED <br />
                ...
                <tr>
                  <td height="21" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td width="91" height="21" align="center" valign="middle" bgcolor="#FF3300">
                        <label>
                          <input name="Status" type="radio" value="7B" <?php if ($order['status'] == '7B'){ ?> checked="checked" <?php } ?> />
                        </label>               </td>
                      </tr>
                  </table></td>
                </tr>
      ...
      <td height="40" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="489" rowspan="2" align="left" valign="middle" bgcolor="#FFFFCC" style="vertical-align:middle;" >
            ...
            <td width="57" rowspan="2" align="center" valign="middle" bgcolor="#FFFFCC"><input name="COCASEPromoBsubmit" type="image" src="../Images/AdminImages/GObuttonOFF.jpg" width="34" height="34" id="Image16" value="Submit"  onmouseover="MM_swapImage('Image16','','../Images/AdminImages/GObuttonON.jpg',1)" onmouseout="MM_swapImgRestore()" /></td>
...
function setPOSTData(Order $orderObj){
    ...
    $orderObj->setStatus4A_delete($_POST['status4A_delete_button']);
    $orderObj->setStatus4A_apple($_POST['status4A_apple_button']);
    $orderObj->setStatus4A_demo($_POST['status4A_demo_button']);
    $orderObj->setStatus4B_delete($_POST['status4B_delete_button']);
    $orderObj->setStatus4B_apple($_POST['status4B_apple_button']);
    $orderObj->setStatus4B_demo($_POST['status4B_demo_button']);
