...
if (!empty($_SESSION['loggedIn']) && ($_SESSION['loggedIn'] == 1) && !empty($_SESSION['email']) && !empty($_SESSION['isAdmin']) && ($_SESSION['isAdmin'] == 1)) {
    ...
    if (isset($_POST['customerPersonalInfo_x']) && isset($_POST['customerPersonalInfo_y'])){
        ...
        if($action['result'] != 'error'){
            ...
            if ($result == 1){
                ...
                array_push($text,'Customer\'s profile information is updated successfully.');
        ...
        $result = $profile->fetchBasedOnLoginid($_GET['clientid']);
    }
...
<meta name="ROBOTS" content="NOINDEX,NOFOLLOW">
<title>Green Apple Mail  &copy; 2012 - CUSTOMERS PROFILE</title>
  ...
  <table width="1000" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td colspan="2" rowspan="3" valign="top">
          <form id="ADMINCUSTOMERSPROFILEform" name="ADMINCUSTOMERSPROFILEform" method="post" action="">
       <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="958" height="34" valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
              <td width="390" height="34" align="right" valign="middle" bgcolor="#FFFFFF" class="style1">Check Orders folder for this customer : </td>
              <td width="70" align="center" valign="middle" bgcolor="#FFFFFF" class="style1"><a href="adminCustomerOrders.php?clientid=<?php echo $profile->getLoginId(); ?>" target="_top"><img src="../Images/FolderImage.png" width="34" height="22" border="0" /></a></td>
                  <td width="498" valign="top" bgcolor="#FFFFFF"><!--DWLayoutEmptyCell-->&nbsp;</td>
              </tr>
          ...
          <td height="388" valign="top" >
            <div align="center">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                <!--DWLayoutTable-->
                <tr>
                  <td width="508" height="359" valign="top"><div align="center">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      
                      <!--DWLayoutTable-->
                      <tr>
                        <td width="179" height="31">&nbsp;</td>
                            <td width="274" align="left" valign="middle" ><strong class="style1">INFORMATION </strong></td>
                          </tr>
                      <tr>
                        <td height="31" align="right" valign="middle"><span class="style1">First name: </span></td>
                            <td align="left" valign="middle">
                              <input name="USERfirstname" type="text" class="style1" id="USERfirstname" value="<?php echo $profile->getFName(); ?>" size="30" maxlength="60" />                            </td>
                          </tr>
                      <tr>
                        <td height="31" align="right" valign="middle"><span class="style1">Last name: </span></td>
                            <td align="left" valign="middle"><input name="USERlastname" type="text" class="style1" id="USERlastname" value="<?php echo $profile->getLName(); ?>" size="30" maxlength="60" /></td>
                      </tr>
                      <tr>
                        <td height="31" align="right" valign="middle"><span class="style1">Company name: </span></td>
                            <td align="left" valign="middle"><input name="USERcompany" type="text" class="style1" id="USERcompany" value="<?php echo $profile->getCompanyName(); ?>" size="30" maxlength="60" /></td>
                          </tr>
                      <tr>
                        <td height="31" align="right" valign="middle"><span class="style1">Address 1: </span></td>
                            <td align="left" valign="middle"><input name="USERaddress1" type="text" class="style1" id="USERaddress1" value="<?php echo $profile->getAddress1(); ?>" size="30" maxlength="60" /></td>
                          </tr>
                      <tr>
                        <td height="31" align="right" valign="middle"><span class="style1">Address 2: </span></td>
                            <td align="left" valign="middle"><input name="USERaddress2" type="text" class="style1" id="USERaddress2" style="resize:none;" value="<?php echo $profile->getAddress2(); ?>" size="30" maxlength="60" /></td>
                          </tr>
                      <tr>
                        <td height="31" align="right" valign="middle"><span class="style1">City:</span></td>
                            <td align="left" valign="middle"><input name="USERcity" type="text" class="style1" id="USERcity" style="resize:none;" value="<?php echo $profile->getCity(); ?>" size="30" maxlength="60" /></td>
                          </tr>
                      <tr>
                        <td height="31" align="right" valign="middle"><span class="style1">State:</span></td>
                            <td align="left" valign="middle"><input name="USERstate" type="text" class="style1" id="USERstate" style="resize:none;" value="<?php echo $profile->getState(); ?>" size="30" maxlength="60" /></td>
                          </tr>
                      <tr>
                        <td height="31" align="right" valign="middle"><span class="style1">Zip Code:</span></td>
                            <td align="left" valign="middle"><input name="USERzipcode" type="text" class="style1" id="USERzipcode" style="resize:none;" value="<?php echo $profile->getZipcode(); ?>" size="30" maxlength="30" /></td>
                          </tr>
                      <tr>
                        <td height="31" align="right" valign="middle"><span class="style1">Country:</span></td>
                            <td align="left" valign="middle"><input name="USERcountry" type="text" class="style1" id="USERcountry" style="resize:none;" value="<?php echo $profile->getCountry(); ?>" size="30" maxlength="60" /></td>
                          </tr>
                      <tr>
                        <td height="31" align="right" valign="middle"><span class="style1">Phone:</span></td>
                            <td align="left" valign="middle"><input name="USERphone" type="text" class="style1" id="USERphone" style="resize:none;" value="<?php echo $profile->getPhone(); ?>" size="30" maxlength="60" /></td>
                          </tr>
                      <tr>
                        <td height="0"></td>
                        <td></td>
                    ...
                    <td width="490" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td colspan="2" align="left" valign="middle"><input name="USERpassword" type="text" class="style1" id="USERpassword" style="resize:none;" value="<?php echo $profile->getPassword(); ?>" size=".35" maxlength="60" /></td>
                        </tr>
                        <tr>
                          <td height="31" align="right" valign="middle"><span class="style1">New Password:</span></td>
                          <td colspan="2" align="left" valign="middle"><input name="USERnewpassword" type="text" class="style1" id="USERnewpassword" style="resize:none;" value="" size="35" maxlength="60" /></td>
                        </tr>
                        <tr>
                          <td height="31" align="right" valign="middle"><span class="style1">Re-enter Password:</span></td>
                          <td colspan="2" align="left" valign="middle"><input name="USERrepassword" type="text" class="style1" id="USERrepassword" style="resize:none;" value="" size="35" maxlength="60" /></td>
                        </tr>
                        <tr>
                          <td height="22">&nbsp;</td>
                          <td width="90">&nbsp;</td>
                          <td width="170" rowspan="2" align="center" valign="top">
                            <label>
                              <input name="customerPersonalInfo" type="image" id="Image10" onmouseover="MM_swapImage('Image10','','../Images/GAMButtonSaveON.jpg',1)" onmouseout="MM_swapImgRestore()" value="Submit" src="../Images/GAMButtonSaveOFF.jpg" width="140" height="66" />
                            </label></td>
                        </tr>
                        <tr>
                          <td height="58" colspan="2" align="center" valign="top" class="style3"><span class="style100">DELETE CUSTOMER FOREVER<br />
                          PULSE HERE</span> <a target="_top" onclick="return popupnow('../securezone/WarningMessage.php?&clientid=<?php echo $profile->getClientId(); ?>&from=admincustomersprofile')"><img src="../Images/DeleteRound.png" width="22" height="22" border="0" /></a></td>
                          </tr>
