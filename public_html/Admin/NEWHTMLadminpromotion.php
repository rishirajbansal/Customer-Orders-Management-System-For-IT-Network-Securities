...
if (!empty($_SESSION['loggedIn']) && ($_SESSION['loggedIn'] == 1) && !empty($_SESSION['email']) && !empty($_SESSION['isAdmin']) && ($_SESSION['isAdmin'] == 1)) {
    ...
    if (isset($_POST['promotion_x']) && isset($_POST['promotion_y'])){       
        
        $newAdmins = array();
        preventSQLInjection($promotion);
  ...
  <table width="1000" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
      ...
      <td colspan="2" rowspan="3" valign="top">
          <form id="PROMOTIONsetupformA" name="PROMOTIONsetupformA" method="post" action="">
            ...
            <tr>
              <td width="170" height="66" align="right" valign="middle" class="style1">Activate Promotion </td>
                  ...
                  <td width="43" align="center" valign="middle">
                    <label>
                        <input  type="Checkbox" name="PromotypeA" value="A"  <?php if ($promotion->getActivatedPromotion() == 'A') echo 'checked="checked"'; ?>   />
                    </label>              </td>
                  <td width="146" align="right" valign="middle" class="style1">Promo code : </td>
                  <td width="283" align="center" valign="middle">
                    <label>
                        <input name="promocodeA" type="text" class="style1" value="<?php echo $promotion->getPromoCode(); ?>" size="30" />
                    </label>              </td>
            ...
            <tr>
              <td width="200" height="50" align="right" valign="top" class="style1">Select dates range from: </td>
                  <td width="200" align="center" valign="top">
                    <label>
                        <input name="promostarts"  type="date"  class="style1" id="promostarts" value="<?php echo $promotion->getValidFrom(); ?>" size="20" />
                    </label>              </td>
                  <td width="40" align="center" valign="top" class="style1">TO</td>
                  <td width="200" align="center" valign="top"><input name="promoends"  type="date"  class="style1" id="promoends" value="<?php echo $promotion->getValidTill(); ?>" size="20" /></td>
        ...
        <tr>
         ...
         <tr>
          ...
          <td width="141" height="56" align="center" valign="middle" bgcolor="#FFFFFF" class="style1">Promo A <br />
           ...
           <td width="817" height="164" align="center" valign="middle" bgcolor="#FFFFFF"><textarea name="textarea" cols="160" rows="9" class="style12" id="textarea"><?php echo $promotion->getFinePrint(); ?>
                      </textarea></td>
            </tr>
            </table>
			</td>
		 ...
		 <!--   *************************    HERE ENDS PROMO A AND STARTS PROMO B FORMAT       ***************************   -->
		  
		  
		  <form id="PROMOTIONsetupformB" name="PROMOTIONsetupformB" method="post" action="">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
       
          <td width="958" height="30" align="center" valign="middle" bgcolor="#B4C2CB" class="style3 style107" ><span class="style106">PROMOTION TYPE </span>B </td>
          </tr>
		  <tr>
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
            ...
            <tr>
              <td width="170" height="66" align="right" valign="middle" class="style1">Activate Promotion </td>
                  ...
                  <td width="43" align="center" valign="middle"><input  type="Checkbox" name="PromotypeB" value="B" <?php if ($promotion->getActivatedPromotion() == 'B') echo 'checked="checked"'; ?>  /></td>
                  <td width="146" align="right" valign="middle" class="style1">Promo code : </td>
                  <td width="289" align="center" valign="middle">
                    <label>
                        <input name="promocodeB" type="text" class="style1" value="<?php echo $promotion->getPromoCode(); ?>" size="30" />
                    </label>              </td>
          ...
          <td height="131" valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td width="141" height="131" align="center" valign="middle" bgcolor="#FFFFFF" class="style1">Promo B <br />
                Fine print : </td>
                <td width="817" align="center" valign="middle" bgcolor="#FFFFFF"><textarea name="fineprinttype" cols="160" rows="9" class="style12" id="fineprinttype"><?php echo $promotion->getFinePrint(); ?>
                      </textarea></td>
                  </tr>
...
function preventSQLInjection(Promotion $promotion){
    $promotionsA = array();
    $promotionsB = array();
    $promoType = '';
    ...
    $promoStarts = mysql_real_escape_string($_POST['promostarts']);
    $promoEnds = mysql_real_escape_string($_POST['promoends']);
    $promoFinePrint = mysql_real_escape_string($_POST['fineprinttype']);
    ...
    $promotion->setActivatedPromotion($promoType);
    $promotion->setPromoCode($promoCode);
    $promotion->setValidFrom($promoStarts);
    $promotion->setValidTill($promoEnds);
    $promotion->setFinePrint($promoFinePrint);
