...
if (!empty($_SESSION['loggedIn']) && ($_SESSION['loggedIn'] == 1) && !empty($_SESSION['email']) && !empty($_SESSION['isAdmin']) && ($_SESSION['isAdmin'] == 1)) {
    ...
    $_SESSION['redirectedFrom'] = 'adminCustomerOrders';
...
<meta name="ROBOTS" content="NOINDEX,NOFOLLOW">
<title>Green Apple Mail  &copy; 2012 - CUSTOMER ORDERS</title>
...
<div align="center">
  <table width="1001" border="0" cellpadding="0" cellspacing="0">
      ...
      <td height="36" colspan="4" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="385" height="36" valign="top"><img src="../Images/AdminImages/GAMUAdminLonBarLEFT.jpg" width="385" height="36" /></td>
           <td width="615" align="right" valign="middle"  background="../Images/AdminImages/GAMUAdminLonBarRIGHT.jpg"  style="background-position:left"><span class="style105">Monday February 22 2013 TIME: 12:35 PM</span> </td>
          </tr>
    ...
    <tr>
      <td width="21" rowspan="3" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
        <tr>
          <td height="10"></td>
          </tr>
      ...
      <td colspan="2" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
        <tr>
          <td width="358" height="32" align="right" valign="middle" bgcolor="#FFFFFF" class="style1">Check this customer's profile: </td>
            <td width="69" align="center" valign="middle" bgcolor="#FFFFFF"><a href="admincustomersprofile.php?clientid=<?php echo $_GET['clientid']; ?>" target="_top"><img src="../Images/AdminImages/EditButton.png" width="34" height="22"  border="none"/></a></td>
            <td width="531" valign="top" bgcolor="#FFFFFF"><!--DWLayoutEmptyCell-->&nbsp;</td>
          </tr>
    ...
    <tr>
      <td colspan="2" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="463" align="center" valign="middle" bgcolor="#222641" ><iframe src="../Admin/customerCase.php?clientid=<?php echo $_GET['clientid']; ?>" width="900" height="440" frameborder="0" scrolling="yes" ></iframe></td>
                </tr>
            <tr>
